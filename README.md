...
Once the `conda-forge` channel has been enabled, `metamorpheus` can be installed with:

```
conda install metamorpheus
```

It is possible to list all of the versions of `metamorpheus` available on your platform with:
